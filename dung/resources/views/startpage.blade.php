...
<body>
    ...
    <div id="search">
        ...
        <a href="nmap://route/walk?slat=&slng=&sname=&dlat=37.4764356&dlng=126.9618302&dname=&appname=https://x-angels.ml" id="serach1">@if (count($rows)){{ $rows[0]->toiletName }}@endif</a>
